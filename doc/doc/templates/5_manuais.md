...
- Incorporar un selector de idioma y de tema de la web.
- Añadir un botón "↑" que aparezca tras hacer scroll vertical en las vistas con listado de tiendas/productos/usuarios, al clicarlo llevará al inicio de la vista de nuevo.
- Continuar con el testing para encontrar más posibles bugs que parchear o mejoras que implementar.
